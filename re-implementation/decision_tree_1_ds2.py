...
for i in range(utilities.DS2_LABEL_SIZE):
	p = count_label[i] / utilities.DS2_TRAIN_SIZE
...
first_set = []
for i in range(utilities.DS2_TRAIN_SIZE):
	first_set.append(i)
...
for row in range(utilities.DS2_VAL_SIZE):
	current_node = tree
	prediction = -1
